 ...
 * @dev Factory contract for creating NFT auction instances using Uniswap V2 pattern
 */
contract NFTAuctionFactory is ReentrancyGuard, Ownable, Initializable {
    ...
    function createAuction(
        ...
        NFTAuction(auction).initialize(priceFeed, address(this));
